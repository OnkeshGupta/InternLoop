      ...
      <div className="theme-student">
        ...
        <div className="mb-8 animate-fade-in">
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            ...
            <div className="card-glass">
              <div className="text-2xl font-bold" style={{ color: "var(--color-primary)" }}>3</div>
              <div className="text-sm text-slate-600">In Progress</div>
            </div>
            <div className="card-glass">
              <div className="text-2xl font-bold" style={{ color: "var(--color-primary)" }}>850</div>
            ...
            <div className="card-glass mb-6">
              <div className="flex gap-4 items-center flex-wrap">
                <div>
                  ...
                  <select value={field} onChange={e => setField(e.target.value)} className="input-field">
                    <option>All</option>
                ...
                <div>
                  ...
                  <select value={paidOnly} onChange={e => setPaidOnly(e.target.value)} className="input-field">
                    <option>All</option>
                    <option>Paid</option>

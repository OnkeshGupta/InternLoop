        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 p-8 animate-slide-up">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-slate-900">Get Started with InternLoop</h2>
              <p className="text-slate-600 mt-2">Find and develop your next generation of talent</p>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-slate-200 text-center text-slate-600">
              Already have an account? <Link to="/login/company" className="text-company-600 font-semibold hover:underline">Login here</Link>
            </div>
          </div>
        </div>
      </div>
